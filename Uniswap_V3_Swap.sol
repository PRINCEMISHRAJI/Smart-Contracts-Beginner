...
/* Author: Ankit Mishra
   Smart Contract on Uniswap V3 Swap Example.
   Uniswap V3 utilizes a new CPMM design intended to optimize capital efficiency
   UniSwap V3 removes the need to track previous values of the accumulator externally.
   This is achieved by storing an array of cumulative sums instead of just one,
      making it possible to calculate TWAP within the past on a single chain call
   To test this smart contract using Foundary I've provided code at bottom in comments
*/
...
/*  We can test this smart contract using Foundary
    Copy and paste this into test folder in your foundry project.
