...
/*  Author: Ankit Mishra
    ...
    */
    ...
    /*
    1. Binod deploys FindThisHash with 10 Ether.
    2. Raju finds the correct string that will hash to the target hash. ("Ethereum")
    3. Raju calls solve("Ethereum") with gas price set to 15 gwei.
    4. Raju is watching the transaction pool for the answer to be submitted.
    5. Raju sees Bob's answer and calls solve("Ethereum") with a higher gas price
    than Bob (100 gwei).
    6. Raju's transaction was mined before Bob's transaction.
    Raju won the reward of 10 ether.
